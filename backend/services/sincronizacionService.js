  ...
  await sequelize.query(
        ...
        fecha_actualizacion_direccion_cliente = EXCLUDED.fecha_actualizacion_direccion_cliente`,
    {
      replacements: {
        ...
        estado                  : Number.isFinite(parseInt(doc.location_status, 10)) ? parseInt(doc.location_status, 10) : 1,
        estado_ubicacion        : Number.isFinite(parseInt(doc.geo_area_code, 10))   ? parseInt(doc.geo_area_code,   10) : 3,
