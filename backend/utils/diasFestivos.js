...
// Fuente: Ministerio del Trabajo / Registro Oficial Ecuador
// ============================================================
...
const festivos = [
  ...
  new Date(2025,  2,  3),  // 03 Mar — Carnaval (lunes)      [Miércoles de Ceniza: 05 Mar]
  new Date(2025,  2,  4),  // 04 Mar — Carnaval (martes)
  new Date(2025,  3, 17),  // 17 Abr — Jueves Santo          [Pascua: 20 Abr]
  ...
  new Date(2025, 10,  4),  // 04 Nov — Independencia de Cuenca [Nov 3 = lun, traslado a mar]
  ...
  // 2026
  // ─────────────────────────────────────────
  new Date(2026,  0,  1),  // 01 Ene — Año Nuevo
  new Date(2026,  1, 16),  // 16 Feb — Carnaval (lunes)      [Miércoles de Ceniza: 18 Feb]
  new Date(2026,  1, 17),  // 17 Feb — Carnaval (martes)
  new Date(2026,  3,  2),  // 02 Abr — Jueves Santo          [Pascua: 05 Abr]
  new Date(2026,  3,  3),  // 03 Abr — Viernes Santo
  new Date(2026,  4,  1),  // 01 May — Día del Trabajo
  new Date(2026,  4, 25),  // 25 May — Batalla de Pichincha  [May 24 = dom → traslado lun]
  new Date(2026,  7, 10),  // 10 Ago — Primer Grito de Independencia
  new Date(2026,  9,  9),  // 09 Oct — Independencia de Guayaquil
  new Date(2026, 10,  2),  // 02 Nov — Día de los Difuntos
  new Date(2026, 10,  3),  // 03 Nov — Independencia de Cuenca
  new Date(2026, 11,  7),  // 07 Dic — Fundación de Quito    [Dic 6 = dom → traslado lun]
  new Date(2026, 11,  8),  // 08 Dic — Inmaculada Concepción
  new Date(2026, 11, 25),  // 25 Dic — Navidad
...
module.exports = { festivos, esFestivo, getDiasHabilesTranscurridos, getDiasLaborablesMes, getDiasHabiles };
