...
//
// ⚠️ Hay una copia de este archivo en mcp-server/src/util/diasFestivos.js
// (proyecto Node separado, sin acceso a backend/). Si actualizas los
// feriados acá, copiá el archivo de nuevo allá — mcp-server/test/
// diasFestivos-sync.test.js falla si se desincronizan.
// ============================================================
