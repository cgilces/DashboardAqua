...
const TablaDomicilioBotellon: React.FC<Props> = ({ anio, mes, datos, esMesActual = false }) => {
  ...
  const irClientes = () => navigate(`/domicilio-botellon/clientes/${anio}/${mes}`);
    ...
    <div className="bg-[#012E24] text-white rounded-lg shadow-md border border-[#046C5E] mb-6 md:mb-8 overflow-hidden">
      <div className="flex flex-col gap-3 md:gap-4 md:flex-row md:items-center md:justify-between px-3 sm:px-4 py-3 sm:py-4">
        <div className="flex flex-col gap-1">
          <h2 className="text-base sm:text-lg md:text-xl font-bold text-green-300 leading-tight">DOMICILIO</h2>
          <p className="text-xs sm:text-sm text-gray-300">Botellones — Canal Domicilio (facturas A%)</p>
        </div>
      ...
      <div className="md:hidden px-3 pb-4">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <span className="font-bold text-blue-300 text-sm">DOMICILIO BOTELLÓN</span>
