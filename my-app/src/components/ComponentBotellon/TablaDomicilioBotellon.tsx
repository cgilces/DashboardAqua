    ...
    <div className="bg-[#012E24] text-white rounded-lg shadow-md border border-[#046C5E] mb-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between px-4 py-4">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg md:text-xl font-bold text-green-300 leading-tight">DOMICILIO</h2>
          <p className="text-sm text-gray-300">Botellones — Canal Domicilio (facturas A%)</p>
        </div>
      ...
      {/* TABLA — una sola fila clickeable */}
      <div className="overflow-x-auto">
        <table className="min-w-full text-sm">
          ...
          <tbody>
            <tr
              onClick={() => navigate(`/domicilio-botellon/clientes/${anio}/${mes}`)}
