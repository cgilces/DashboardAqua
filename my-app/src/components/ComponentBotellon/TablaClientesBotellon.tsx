        ...
        <>
          ...
          <div className="flex justify-center mb-4 px-4">
            <div className="relative w-full md:w-1/2">
              <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/60 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 rounded-lg bg-[#046C5E] border border-[#0db48b]/30 text-white text-sm placeholder-white/40 focus:outline-none focus:border-emerald-400/60 transition-all"
              />
              {terminoBusqueda && (
                <button onClick={() => setTerminoBusqueda("")}
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 text-white/40 transition leading-none">
                  <X size={14} />
                </button>
              )}
            </div>
