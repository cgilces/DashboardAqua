    ...
    <div className="bg-[#012E24] text-white rounded-lg shadow-md border border-[#046C5E] mb-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between px-4 py-4">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg md:text-xl font-bold text-green-300 leading-tight">EMPRESAS</h2>
          <p className="text-sm text-gray-300">Botellones — Canal Empresa (facturas E% + Odoo rutas empresa)</p>
        </div>
