...
export default function ConfigurarMetasBotellon() {
  ...
  return (
    <div className="min-h-screen bg-[#011f18] text-white">
      ...
      {/* Toast */}
      {toast && (
        <div className={`fixed top-5 right-5 z-[100] flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-2xl text-sm font-semibold border backdrop-blur-sm
          ${toast.tipo === "ok"
          ...
          <div className="w-full max-w-md bg-[#012a20] border border-white/10 rounded-2xl shadow-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setEditando(null)}
                className="w-7 h-7 rounded-lg bg-white/5 hover:bg-white/10 text-white/40 hover:text-white transition flex items-center justify-center text-sm">✕</button>
            </div>
